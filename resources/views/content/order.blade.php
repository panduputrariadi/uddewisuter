        ...
        <div class="d-inline-flex">
            <div class="" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Order Anda</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="container-fluid pt-1">
    <div class="row px-xl-5">
        <small id="emailHelp" class="form-text text-muted" style="font-style: italic; color: #999;">Lengkapi Data Diri Anda</small>
                    ...
                    @foreach ($order as $item)
                        <tr>
                            <td class="align-middle"><img src="img/product-1.jpg" alt="" style="width: 50px;">
                                {{ $item->product['namaProduk'] }} {{ Str::limit($item->product->category['namaKategori'], 30, '...') }}
                            </td>
                            <td class="align-middle">Rp {{ number_format($item->product->category['harga'], 0, ',', '.') }}</td>
                            ...
                            <td class="align-middle">
                                <a href="hapusOrder/{{$item->id}}" data-confirm-delete="true" class="delete-confirmation">
                                    <button class="btn btn-sm btn-primary">
                                        <i class="fa fa-times"></i>
                                    </button>
                                </a>
                                <a href="" class="text-dark" data-bs-toggle="modal" data-bs-target="#editOrder_{{$item->id}}">
